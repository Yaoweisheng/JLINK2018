package com.Jlink.config.redis;

import com.Jlink.cache.JedisPoolWriper;
...
public class RedisConfiguration {
	...
	public JedisUtil.Keys createJedisKeys(){
		JedisUtil.Keys jedisKeys = jeditsUtil.new Keys();
		return jedisKeys;
	}
	...
	public JedisUtil.Strings createJediStrings(){
		JedisUtil.Strings jedisStrings = jeditsUtil.new Strings();
		return jedisStrings;
	}
}
